# Отчёт о тестировани Credit card Number Validator
...
[Валидные номера карт длиной 16 цифр не проходят проверкусание ](адрес "https://github.com/NikiHollywood/1.1-vvedeniye-java/issues/5") 
