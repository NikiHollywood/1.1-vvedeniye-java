...
[В списке из Валидных ключей для проверки, два ключа не являются валидными](https://github.com/NikiHollywood/1.1-vvedeniye-java/issues/1 "issui")

[В списке из Невалидных ключей для проверки, один ключ является валидным](https://github.com/NikiHollywood/1.1-vvedeniye-java/issues/2 "issui")
